...
<div
    class="{{ $zIndex }} fixed inset-0 overflow-y-auto"
    x-data="wireui_modal({
        show: @js($show),
...
>
    <div
        class="{{ $align }} {{ $spacing }} relative flex min-h-screen w-full transform items-end justify-center transition-all"
